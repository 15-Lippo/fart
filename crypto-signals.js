...
// Versione 2.5.0 - Aggiornato per utilizzare solo CoinGecko

// ---- CONFIGURAZIONE API ----
const COINGECKO_API_URL = 'https://api.coingecko.com/api/v3';
const USE_PROXY = true; // Usa proxy per evitare CORS
const PROXY_URL = 'https://api.allorigins.win/raw?url='; // Cambio il proxy per uno più affidabile

// Configurazione timeout e ritardi
const API_TIMEOUT_MS = 30000; // Aumentato a 30 secondi
const REQUEST_DELAY_MS = 2000; // Aumentato a 2 secondi
...
async function checkApiStatus() {
    try {
        ...
        const url = USE_PROXY 
            ? `${PROXY_URL}${encodeURIComponent(COINGECKO_API_URL + '/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=20&sparkline=false&price_change_percentage=24h')}`
...
export async function getCryptoSignals() {
    try {
        ...
        // Verifica immediatamente se l'API è disponibile
